    ...
    <div class="table"><div id="printableArea">
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td>Ticket Id </td><td>" . $row["tid"] . "</td></tr><tr>";
                echo "<td>Passenger Name </td><td>" . $row["name"] . "</td></tr><tr>";
				echo "<td>Passport Number </td><td>" . $row["passport"] . "</td></tr><tr>";
                echo "<td>Email </td><td>" . $row["email"] . "</td></tr><tr>";
                echo "<td>Boarding </td><td>" . $row["boarding"] . "</td></tr><tr>";
                echo "<td>Destination </td><td>" . $row["destination"] . "</td></tr><tr>";
                echo "<td>Journey Date </td><td>" . $row["date"] . "</td></tr>";
                echo "</table>";
            }
		}
                mysqli_close($conn);
